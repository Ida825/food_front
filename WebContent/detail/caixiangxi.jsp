		...
		<div id="menu1">
			...
			<div class="menu3">
				<div class="menu3_left">
					<img src="${pageContext.request.contextPath}/showImage?imgName=${param.imgPath}"
			...
			<div class="menu4">
				...
				<a href="${pageContext.request.contextPath}/foodCart?fid=${param.fid }&fname=${param.fname}&price=${param.price}" style="background:url(style/images/img/order_left_corner_bg.png);">放入餐车</a>
